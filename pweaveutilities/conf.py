...
project = u'Pweave Utilities'
copyright = u'2015, the cloistered monkey'
...
html_short_title = 'Pweave Utilities'
...
latex_documents = [
  ('index', 'pweaveutilities.tex', basename + u' Documentation',
   u'russelln', 'manual'),
]
